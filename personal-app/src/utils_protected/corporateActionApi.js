...
export async function putCorporateActions(ticker, startDate, endDate, corporateActions, setCorporateActions) {
  const data = [];
  return corporateActionApi("PUT", data, setCorporateActions);
}
